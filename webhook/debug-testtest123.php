...
if (!file_exists($log_file)) {
    // Versuch alternatives Log-Verzeichnis
    $log_file = dirname(__DIR__) . '/webhooks/webhook.log';
}
...
if (file_exists($log_file)) {
    ...
    echo "❌ WEBHOOK LOG NICHT GEFUNDEN!<br>";
    echo "Gesucht in: $log_file<br>";
}
