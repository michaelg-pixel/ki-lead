 ...
 * Admin kann hier Produkt-IDs hinterlegen und alle Kunden eines Tarifs aktualisieren
 */
...
<style>
/* [Alle existierenden Styles bleiben gleich] */
.digistore-container {
    padding: 30px;
}
...
<div class="digistore-container">
    ...
    <div class="help-text">
        ...
        4. Nutze "Alle Kunden aktualisieren" um alle bestehenden Kunden auf neue Limits zu setzen<br>
